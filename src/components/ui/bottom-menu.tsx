    ...
    <div className={cn("relative", className)} {...props}>
      ...
      <div 
        ...
        className={cn(
          ...
          "rounded-full bg-[#2a2a2a]/95 backdrop-blur",
          "border border-[rgba(255,255,255,0.1)]",
          "shadow-[0_0_0_1px_rgba(255,255,255,0.08),0_8px_16px_-4px_rgba(0,0,0,0.2)]"
        )}
      >
        {items.map((item, index) => (
          <button 
            key={index}
            className="w-8 h-8 rounded-full flex justify-center items-center hover:bg-[#3a3a3a] transition-colors"
